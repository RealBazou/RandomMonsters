...
namespace RandomMonsters
{
    public static class Main
    {
        ...
        internal static void OnGameReady()
        {
            ...
            //
            skeleton.GuiPresentation.Title = "RandomMonsters/&FancySkeletonTitle";
            skeleton.GuiPresentation.Description = "RandomMonsters/&FancySkeletonDescription";
        }
    }
}
